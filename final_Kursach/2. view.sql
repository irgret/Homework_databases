...
Тоже самое второе представление мы можем сделать с помощью процедуры, об этом ниже. Но не можем посчитать
среднее арифметическое по полученным данным. Как вложить в скобки AVG() вложенный запрос, я пока не знаю.*/