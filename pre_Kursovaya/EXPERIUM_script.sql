...
DROP TABLE IF EXISTS o_status; -- 13. статус проекта (новый проект, в работе, завершен)
...
DROP TABLE IF EXISTS u_status; -- 15. тип юзера в заказе (кандидат, претендент, финалист, сотрудник)
